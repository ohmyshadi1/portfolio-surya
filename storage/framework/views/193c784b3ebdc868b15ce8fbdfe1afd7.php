...
} elseif ($_instance->childHasBeenRendered('csWWJrS')) {
    $componentId = $_instance->getRenderedChildComponentId('csWWJrS');
    $componentTag = $_instance->getRenderedChildComponentTagName('csWWJrS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('csWWJrS');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('csWWJrS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('2MAjnAm')) {
    $componentId = $_instance->getRenderedChildComponentId('2MAjnAm');
    $componentTag = $_instance->getRenderedChildComponentTagName('2MAjnAm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2MAjnAm');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('2MAjnAm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\project php\Portfolio Surya\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>