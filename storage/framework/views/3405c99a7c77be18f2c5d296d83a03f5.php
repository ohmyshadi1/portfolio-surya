...
} elseif ($_instance->childHasBeenRendered('lAxiemW')) {
    $componentId = $_instance->getRenderedChildComponentId('lAxiemW');
    $componentTag = $_instance->getRenderedChildComponentTagName('lAxiemW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lAxiemW');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('lAxiemW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('yRGLu27')) {
    $componentId = $_instance->getRenderedChildComponentId('yRGLu27');
    $componentTag = $_instance->getRenderedChildComponentTagName('yRGLu27');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yRGLu27');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('yRGLu27', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\project php\PORTOFOLIO\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>