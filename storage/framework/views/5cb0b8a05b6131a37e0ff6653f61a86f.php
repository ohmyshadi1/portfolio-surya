...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <div class="header-social-links">
        <a href="<?php echo e($twitter); ?>" class="twitter"><i class="bi bi-twitter"></i></a>
        <a href="<?php echo e($facebook); ?>" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="<?php echo e($instagram); ?>" class="instagram"><i class="bi bi-instagram"></i></a>
        <a href="<?php echo e($youtube); ?>" class="youtube"><i class="bi bi-youtube"></i></i></a>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>I'm <span><?php echo e($jumbotron->title); ?></span><?php echo strip_tags($jumbotron->content); ?></h2>
          <p><?php echo strip_tags($subjumbo->content); ?></p>
  ...
  <section id="about" class="about" data-aos="fade" data-aos-delay="1500">
    <div class="container2">
      <img src="<?php echo e(Storage::url($about->thumbnail)); ?>" alt="..." class="foto"/>
      <div class="row d-flex justify-content-center">
        <div class="col-lg-10 text-left">
          <h2><span><?php echo e($about->title); ?></span></h2>
          <p><?php echo strip_tags($about->content); ?></p>
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
    ...
    <!-- Project Section <?php echo e($i); ?> -->
    <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
      <div class="gallery-item h-100">
        <img src="<?php echo e(Storage::url($item->thumbnail)); ?>" class="img-fluid" alt="">
        <div class="gallery-links d-flex align-items-center justify-content-center">
          <a href="<?php echo e(Storage::url($item->thumbnail)); ?>" title="<?php echo e($item->title); ?>" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
          <div class="subteks">
          <p style="font-family:montserrat; font-weight:bold; font-size:15px; color:white"><?php echo e($item->title); ?></p>
          </div>
          <a href="<?php echo e($item->link); ?>" class="details-link"><i class="bi bi-link-45deg"></i></a>
        </div>
      </div>
    </div>
      <!-- End Project Item <?php echo e($i); ?> -->
      <?php
                $i++;
      ?>
  ...
  <footer id="footer" class="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span><?php echo e($site_name); ?></span></strong>. All Rights Reserved
      </div>
      <div class="credits">
...
</html><?php /**PATH C:\xampp\htdocs\project php\Portfolio Surya\resources\views/index.blade.php ENDPATH**/ ?>