...
} elseif ($_instance->childHasBeenRendered('7RD6NEE')) {
    $componentId = $_instance->getRenderedChildComponentId('7RD6NEE');
    $componentTag = $_instance->getRenderedChildComponentTagName('7RD6NEE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7RD6NEE');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7RD6NEE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project php\Portfolio Surya\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>