...
} elseif ($_instance->childHasBeenRendered('C6jOSNb')) {
    $componentId = $_instance->getRenderedChildComponentId('C6jOSNb');
    $componentTag = $_instance->getRenderedChildComponentTagName('C6jOSNb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C6jOSNb');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('C6jOSNb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project php\PORTOFOLIO\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>