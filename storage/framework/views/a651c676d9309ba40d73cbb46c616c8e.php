...
} elseif ($_instance->childHasBeenRendered('JHnhusA')) {
    $componentId = $_instance->getRenderedChildComponentId('JHnhusA');
    $componentTag = $_instance->getRenderedChildComponentTagName('JHnhusA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JHnhusA');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('JHnhusA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ZQb654m')) {
    $componentId = $_instance->getRenderedChildComponentId('ZQb654m');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZQb654m');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZQb654m');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('ZQb654m', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\project php\PORTOFOLIO - Copy\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>