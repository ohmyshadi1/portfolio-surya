...
} elseif ($_instance->childHasBeenRendered('mOP1xtd')) {
    $componentId = $_instance->getRenderedChildComponentId('mOP1xtd');
    $componentTag = $_instance->getRenderedChildComponentTagName('mOP1xtd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mOP1xtd');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('mOP1xtd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project php\PORTOFOLIO - Copy\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>